...
<form <?php $view->formAttributes(); ?>>
    ...
    <input name="<?php echo MM_WPFS_Admin_FormViewConstants::FIELD_FORM_ID; ?>" value="<?php echo $form->donationFormID; ?>" type="hidden">
        ...
        <div class="wpfs-form__cols">
            <div class="wpfs-form__col">
                <div class="wpfs-form-block">
                    ...
                    <?php include( 'wpfs-form-component-default-product-name.php' ); ?>
