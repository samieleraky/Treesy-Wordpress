 ...
 * @property (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\StripeWPFS\Stripe\StripeObject) $address
 ...
 */
class Location extends \StripeWPFS\Stripe\ApiResource
{
     ...
     * @param null|array|string $opts
     *
     * @return \StripeWPFS\Stripe\Collection<Location> of ApiResources
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
