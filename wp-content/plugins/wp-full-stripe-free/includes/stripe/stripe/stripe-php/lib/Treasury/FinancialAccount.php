 ...
 * @property (object{cash: \StripeWPFS\Stripe\StripeObject, inbound_pending: \StripeWPFS\Stripe\StripeObject, outbound_pending: \StripeWPFS\Stripe\StripeObject}&\StripeWPFS\Stripe\StripeObject) $balance Balance information for the FinancialAccount
 ...
 * @property ((object{aba?: (object{account_holder_name: string, account_number?: null|string, account_number_last4: string, bank_name: string, routing_number: string}&\StripeWPFS\Stripe\StripeObject), supported_networks?: string[], type: string}&\StripeWPFS\Stripe\StripeObject))[] $financial_addresses The set of credentials that resolve to a FinancialAccount.
 ...
 * @property null|(object{inbound_flows: null|string, outbound_flows: null|string}&\StripeWPFS\Stripe\StripeObject) $platform_restrictions The set of functionalities that the platform can restrict on the FinancialAccount.
 ...
 * @property (object{closed: null|(object{reasons: string[]}&\StripeWPFS\Stripe\StripeObject)}&\StripeWPFS\Stripe\StripeObject) $status_details
 ...
 */
class FinancialAccount extends \StripeWPFS\Stripe\ApiResource
{
     ...
     *
     * @return \StripeWPFS\Stripe\Collection<FinancialAccount> of ApiResources
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
    ...
    public function retrieveFeatures($params = null, $opts = null)
    {
        ...
        $obj = \StripeWPFS\Stripe\Util\Util::convertToStripeObject($response, $opts);
        $obj->setLastResponse($response);
        return $obj;
    }
    /**
