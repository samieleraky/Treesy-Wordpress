 ...
 * @property ((object{city: null|string, country: string, latitude: null|float, longitude: null|float, region: null|string}&\StripeWPFS\Stripe\StripeObject))[] $locations The locations in which this supplier operates.
 ...
 */
class Supplier extends \StripeWPFS\Stripe\ApiResource
{
     ...
     *
     * @return \StripeWPFS\Stripe\Collection<Supplier> of ApiResources
     *
