 ...
 */
class FinancialAccountService extends \StripeWPFS\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \StripeWPFS\Stripe\Collection<\StripeWPFS\Stripe\Treasury\FinancialAccount>
     *
     ...
     * @param null|RequestOptionsArray|\StripeWPFS\Stripe\Util\RequestOptions $opts
     *
     * @return \StripeWPFS\Stripe\Treasury\FinancialAccount
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|RequestOptionsArray|\StripeWPFS\Stripe\Util\RequestOptions $opts
     *
     * @return \StripeWPFS\Stripe\Treasury\FinancialAccountFeatures
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
