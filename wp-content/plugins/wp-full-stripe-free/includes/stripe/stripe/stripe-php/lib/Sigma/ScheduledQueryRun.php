...
namespace StripeWPFS\Stripe\Sigma;
 ...
 * @property null|(object{message: string}&\StripeWPFS\Stripe\StripeObject) $error
 * @property null|\StripeWPFS\Stripe\File $file The file object representing the results of the query.
 ...
 */
class ScheduledQueryRun extends \StripeWPFS\Stripe\ApiResource
{
     ...
     *
     * @return \StripeWPFS\Stripe\Collection<ScheduledQueryRun> of ApiResources
     *
