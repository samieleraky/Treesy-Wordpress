 ...
 * @property (object{billing_details: (object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\StripeWPFS\Stripe\StripeObject), email: null|string, name: null|string}&\StripeWPFS\Stripe\StripeObject), financial_account?: (object{id: string, network: string}&\StripeWPFS\Stripe\StripeObject), type: string, us_bank_account?: (object{account_holder_type: null|string, account_type: null|string, bank_name: null|string, fingerprint: null|string, last4: null|string, mandate?: string|\StripeWPFS\Stripe\Mandate, network: string, routing_number: null|string}&\StripeWPFS\Stripe\StripeObject)}&\StripeWPFS\Stripe\StripeObject) $destination_payment_method_details
 ...
 * @property null|(object{code: string, transaction: string|Transaction}&\StripeWPFS\Stripe\StripeObject) $returned_details Details about a returned OutboundTransfer. Only set when the status is <code>returned</code>.
 ...
 */
class OutboundTransfer extends \StripeWPFS\Stripe\ApiResource
{
     ...
     *
     * @return \StripeWPFS\Stripe\Collection<OutboundTransfer> of ApiResources
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
