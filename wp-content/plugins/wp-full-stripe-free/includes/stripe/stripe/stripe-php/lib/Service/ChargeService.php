...
class ChargeService extends AbstractService
{
     ...
     *
     * @return \StripeWPFS\Stripe\Collection<\StripeWPFS\Stripe\Charge>
     *
     ...
     * @param null|RequestOptionsArray|\StripeWPFS\Stripe\Util\RequestOptions $opts
     *
     * @return \StripeWPFS\Stripe\Charge
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|RequestOptionsArray|\StripeWPFS\Stripe\Util\RequestOptions $opts
     *
     * @return \StripeWPFS\Stripe\SearchResult<\StripeWPFS\Stripe\Charge>
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
