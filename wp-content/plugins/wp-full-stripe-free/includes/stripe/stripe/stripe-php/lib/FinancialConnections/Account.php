...
namespace StripeWPFS\Stripe\FinancialConnections;
 ...
 * @property null|(object{account?: string|\StripeWPFS\Stripe\Account, customer?: string|\StripeWPFS\Stripe\Customer, type: string}&\StripeWPFS\Stripe\StripeObject) $account_holder The account holder that this account belongs to.
 * @property null|(object{as_of: int, cash?: (object{available: null|\StripeWPFS\Stripe\StripeObject}&\StripeWPFS\Stripe\StripeObject), credit?: (object{used: null|\StripeWPFS\Stripe\StripeObject}&\StripeWPFS\Stripe\StripeObject), current: \StripeWPFS\Stripe\StripeObject, type: string}&\StripeWPFS\Stripe\StripeObject) $balance The most recent information about the account's balance.
 * @property null|(object{last_attempted_at: int, next_refresh_available_at: null|int, status: string}&\StripeWPFS\Stripe\StripeObject) $balance_refresh The state of the most recent attempt to refresh the account balance.
 ...
 * @property null|(object{last_attempted_at: int, next_refresh_available_at: null|int, status: string}&\StripeWPFS\Stripe\StripeObject) $ownership_refresh The state of the most recent attempt to refresh the account owners.
 ...
 * @property null|(object{id: string, last_attempted_at: int, next_refresh_available_at: null|int, status: string}&\StripeWPFS\Stripe\StripeObject) $transaction_refresh The state of the most recent attempt to refresh the account transactions.
 */
class Account extends \StripeWPFS\Stripe\ApiResource
{
     ...
     *
     * @return \StripeWPFS\Stripe\Collection<Account> of ApiResources
     *
     ...
     * @param null|array|string $opts
     *
     * @return \StripeWPFS\Stripe\Collection<AccountOwner> list of account owners
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
