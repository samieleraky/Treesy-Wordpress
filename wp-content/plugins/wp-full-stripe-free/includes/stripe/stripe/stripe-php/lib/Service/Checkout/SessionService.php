...
namespace StripeWPFS\Stripe\Service\Checkout;
 ...
 */
class SessionService extends \StripeWPFS\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \StripeWPFS\Stripe\Collection<\StripeWPFS\Stripe\Checkout\Session>
     *
     ...
     * @param null|RequestOptionsArray|\StripeWPFS\Stripe\Util\RequestOptions $opts
     *
     * @return \StripeWPFS\Stripe\Collection<\StripeWPFS\Stripe\LineItem>
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
