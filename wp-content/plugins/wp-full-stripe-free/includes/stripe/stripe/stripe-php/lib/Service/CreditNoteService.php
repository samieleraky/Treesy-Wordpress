...
class CreditNoteService extends AbstractService
{
     ...
     *
     * @return \StripeWPFS\Stripe\Collection<\StripeWPFS\Stripe\CreditNote>
     *
     ...
     * @param null|RequestOptionsArray|\StripeWPFS\Stripe\Util\RequestOptions $opts
     *
     * @return \StripeWPFS\Stripe\Collection<\StripeWPFS\Stripe\CreditNoteLineItem>
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|RequestOptionsArray|\StripeWPFS\Stripe\Util\RequestOptions $opts
     *
     * @return \StripeWPFS\Stripe\CreditNote
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
