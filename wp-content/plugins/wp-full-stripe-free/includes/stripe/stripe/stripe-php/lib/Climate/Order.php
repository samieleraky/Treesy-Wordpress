...
namespace StripeWPFS\Stripe\Climate;
 ...
 * @property null|(object{public_name: string}&\StripeWPFS\Stripe\StripeObject) $beneficiary
 ...
 * @property ((object{delivered_at: int, location: null|(object{city: null|string, country: string, latitude: null|float, longitude: null|float, region: null|string}&\StripeWPFS\Stripe\StripeObject), metric_tons: string, registry_url: null|string, supplier: Supplier}&\StripeWPFS\Stripe\StripeObject))[] $delivery_details Details about the delivery of carbon removal for this order.
 ...
 */
class Order extends \StripeWPFS\Stripe\ApiResource
{
     ...
     *
     * @return \StripeWPFS\Stripe\Collection<Order> of ApiResources
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
