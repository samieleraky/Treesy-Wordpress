...
namespace StripeWPFS\Stripe\TestHelpers;
 ...
 * @property (object{advancing?: (object{target_frozen_time: int}&\StripeWPFS\Stripe\StripeObject)}&\StripeWPFS\Stripe\StripeObject) $status_details
 */
class TestClock extends \StripeWPFS\Stripe\ApiResource
{
     ...
     * @param null|array|string $opts
     *
     * @return \StripeWPFS\Stripe\Collection<TestClock> of ApiResources
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
