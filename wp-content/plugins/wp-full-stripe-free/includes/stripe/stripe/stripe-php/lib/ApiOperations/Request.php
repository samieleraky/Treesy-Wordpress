...
namespace StripeWPFS\Stripe\ApiOperations;
...
trait Request
{
     ...
     *
     * @throws \StripeWPFS\Stripe\Exception\InvalidArgumentException if $params exists and is not an array
     */
    protected static function _validateParams($params = null)
    {
        if ($params && !\is_array($params)) {
            $message = 'You must pass an array as the first argument to Stripe API '
                ...
                . "would be: \"StripeWPFS\\Stripe\\Charge::create(['amount' => 100, "
                . "'currency' => 'usd', 'source' => 'tok_1234'])\")";

            throw new \StripeWPFS\Stripe\Exception\InvalidArgumentException($message);
        }
    }
    ...
    /**
     * @param string $url URL for the request
     * @param class-string< \Stripe\Collection|\StripeWPFS\Stripe\SearchResult > $resultClass indicating what type of paginated result is returned
     * @param null|array $params list of parameters for the request
     * @param null|array|string $options
     * @param string[] $usage names of tracked behaviors associated with this request
     *
     * @return \StripeWPFS\Stripe\Collection|\StripeWPFS\Stripe\SearchResult
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
    protected static function _requestPage($url, $resultClass, $params = null, $options = null, $usage = [])
    {
        ...
        if (!$obj instanceof $resultClass) {
            throw new \StripeWPFS\Stripe\Exception\UnexpectedValueException(
    ...
    {
        $opts = \StripeWPFS\Stripe\Util\RequestOptions::parse($options);
        $baseUrl = isset($opts->apiBase) ? $opts->apiBase : static::baseUrl();
        $requestor = new \StripeWPFS\Stripe\ApiRequestor($opts->apiKey, $baseUrl);
