...
namespace StripeWPFS\Stripe\Apps;
 ...
 * @property (object{type: string, user?: string}&\StripeWPFS\Stripe\StripeObject) $scope
 */
class Secret extends \StripeWPFS\Stripe\ApiResource
{
     ...
     *
     * @return \StripeWPFS\Stripe\Collection<Secret> of ApiResources
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
