 ...
 * @property (object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\StripeWPFS\Stripe\StripeObject)}&\StripeWPFS\Stripe\StripeObject) $billing
 * @property null|(object{tax_id_provided: bool}&\StripeWPFS\Stripe\StripeObject) $company Additional information about a <code>company</code> cardholder.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string $email The cardholder's email address.
 * @property null|(object{card_issuing?: null|(object{user_terms_acceptance: null|(object{date: null|int, ip: null|string, user_agent: null|string}&\StripeWPFS\Stripe\StripeObject)}&\StripeWPFS\Stripe\StripeObject), dob: null|(object{day: null|int, month: null|int, year: null|int}&\StripeWPFS\Stripe\StripeObject), first_name: null|string, last_name: null|string, verification: null|(object{document: null|(object{back: null|string|\StripeWPFS\Stripe\File, front: null|string|\StripeWPFS\Stripe\File}&\StripeWPFS\Stripe\StripeObject)}&\StripeWPFS\Stripe\StripeObject)}&\StripeWPFS\Stripe\StripeObject) $individual Additional information about an <code>individual</code> cardholder.
 ...
 */
class Cardholder extends \StripeWPFS\Stripe\ApiResource
{
     ...
     *
     * @return \StripeWPFS\Stripe\Collection<Cardholder> of ApiResources
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
