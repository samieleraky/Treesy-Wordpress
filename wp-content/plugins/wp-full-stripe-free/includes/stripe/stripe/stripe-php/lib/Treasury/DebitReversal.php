 ...
 * @property null|(object{issuing_dispute: null|string}&\StripeWPFS\Stripe\StripeObject) $linked_flows Other flows linked to a DebitReversal.
 ...
 * @property (object{completed_at: null|int}&\StripeWPFS\Stripe\StripeObject) $status_transitions
 * @property null|string|Transaction $transaction The Transaction associated with this object.
 */
class DebitReversal extends \StripeWPFS\Stripe\ApiResource
{
     ...
     *
     * @return \StripeWPFS\Stripe\Collection<DebitReversal> of ApiResources
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
