...
namespace StripeWPFS\Stripe\Service\Sigma;
 ...
 */
class ScheduledQueryRunService extends \StripeWPFS\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \StripeWPFS\Stripe\Collection<\StripeWPFS\Stripe\Sigma\ScheduledQueryRun>
     *
     ...
     * @param null|RequestOptionsArray|\StripeWPFS\Stripe\Util\RequestOptions $opts
     *
     * @return \StripeWPFS\Stripe\Sigma\ScheduledQueryRun
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
