...
class FileService extends AbstractService
{
     ...
     *
     * @return \StripeWPFS\Stripe\Collection<\StripeWPFS\Stripe\File>
     *
    ...
    public function create($params = null, $opts = null)
    {
        ...
        $flatParams = \array_column(\StripeWPFS\Stripe\Util\Util::flattenParams($params), 1, 0);
