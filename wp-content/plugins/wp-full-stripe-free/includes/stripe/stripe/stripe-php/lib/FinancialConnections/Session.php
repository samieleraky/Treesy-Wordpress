 ...
 * @property null|(object{account?: string|\StripeWPFS\Stripe\Account, customer?: string|\StripeWPFS\Stripe\Customer, type: string}&\StripeWPFS\Stripe\StripeObject) $account_holder The account holder for whom accounts are collected in this session.
 * @property \StripeWPFS\Stripe\Collection<Account> $accounts The accounts that were collected as part of this Session.
 * @property string $client_secret A value that will be passed to the client to launch the authentication flow.
 * @property null|(object{account_subcategories: null|string[], countries: null|string[]}&\StripeWPFS\Stripe\StripeObject) $filters
