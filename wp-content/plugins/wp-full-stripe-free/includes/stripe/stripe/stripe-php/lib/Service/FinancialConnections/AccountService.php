...
namespace StripeWPFS\Stripe\Service\FinancialConnections;
 ...
 */
class AccountService extends \StripeWPFS\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \StripeWPFS\Stripe\Collection<\StripeWPFS\Stripe\FinancialConnections\Account>
     *
     ...
     * @param null|RequestOptionsArray|\StripeWPFS\Stripe\Util\RequestOptions $opts
     *
     * @return \StripeWPFS\Stripe\Collection<\StripeWPFS\Stripe\FinancialConnections\AccountOwner>
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|RequestOptionsArray|\StripeWPFS\Stripe\Util\RequestOptions $opts
     *
     * @return \StripeWPFS\Stripe\FinancialConnections\Account
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
