...
class ApplicationFeeService extends AbstractService
{
     ...
     *
     * @return \StripeWPFS\Stripe\Collection<\StripeWPFS\Stripe\ApplicationFee>
     *
     ...
     * @param null|RequestOptionsArray|\StripeWPFS\Stripe\Util\RequestOptions $opts
     *
     * @return \StripeWPFS\Stripe\Collection<\StripeWPFS\Stripe\ApplicationFeeRefund>
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|RequestOptionsArray|\StripeWPFS\Stripe\Util\RequestOptions $opts
     *
     * @return \StripeWPFS\Stripe\ApplicationFeeRefund
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|RequestOptionsArray|\StripeWPFS\Stripe\Util\RequestOptions $opts
     *
     * @return \StripeWPFS\Stripe\ApplicationFee
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
