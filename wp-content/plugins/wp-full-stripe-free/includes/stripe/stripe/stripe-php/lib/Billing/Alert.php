 ...
 * @property null|(object{filters: null|((object{customer: null|string|\StripeWPFS\Stripe\Customer, type: string}&\StripeWPFS\Stripe\StripeObject))[], gte: int, meter: Meter|string, recurrence: string}&\StripeWPFS\Stripe\StripeObject) $usage_threshold Encapsulates configuration of the alert to monitor usage on a specific <a href="https://stripe.com/docs/api/billing/meter">Billing Meter</a>.
 */
class Alert extends \StripeWPFS\Stripe\ApiResource
{
     ...
     *
     * @return \StripeWPFS\Stripe\Collection<Alert> of ApiResources
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
