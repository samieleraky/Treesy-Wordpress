...
namespace StripeWPFS\Stripe\Radar;
 ...
 * @property \StripeWPFS\Stripe\Collection<ValueListItem> $list_items List of items contained within this value list.
 ...
 */
class ValueList extends \StripeWPFS\Stripe\ApiResource
{
     ...
     * @param null|array|string $opts
     *
     * @return \StripeWPFS\Stripe\Collection<ValueList> of ApiResources
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
