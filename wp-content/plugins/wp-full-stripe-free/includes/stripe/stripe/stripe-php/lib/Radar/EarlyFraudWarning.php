 ...
 * @property string|\StripeWPFS\Stripe\Charge $charge ID of the charge this early fraud warning is for, optionally expanded.
 ...
 * @property null|string|\StripeWPFS\Stripe\PaymentIntent $payment_intent ID of the Payment Intent this early fraud warning is for, optionally expanded.
 */
class EarlyFraudWarning extends \StripeWPFS\Stripe\ApiResource
{
     ...
     *
     * @return \StripeWPFS\Stripe\Collection<EarlyFraudWarning> of ApiResources
     *
