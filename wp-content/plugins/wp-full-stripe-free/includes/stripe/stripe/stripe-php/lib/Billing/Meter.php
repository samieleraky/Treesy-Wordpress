 ...
 * @property (object{event_payload_key: string, type: string}&\StripeWPFS\Stripe\StripeObject) $customer_mapping
 * @property (object{formula: string}&\StripeWPFS\Stripe\StripeObject) $default_aggregation
 ...
 * @property (object{deactivated_at: null|int}&\StripeWPFS\Stripe\StripeObject) $status_transitions
 * @property int $updated Time at which the object was last updated. Measured in seconds since the Unix epoch.
 * @property (object{event_payload_key: string}&\StripeWPFS\Stripe\StripeObject) $value_settings
 */
class Meter extends \StripeWPFS\Stripe\ApiResource
{
    const OBJECT_NAME = 'billing.meter';
    use \StripeWPFS\Stripe\ApiOperations\NestedResource;
     ...
     *
     * @return \StripeWPFS\Stripe\Collection<Meter> of ApiResources
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|array|string $opts
     *
     * @return \StripeWPFS\Stripe\Collection<MeterEventSummary> the list of meter event summaries
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
