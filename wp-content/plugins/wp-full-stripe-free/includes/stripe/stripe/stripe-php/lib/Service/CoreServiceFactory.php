...
class CoreServiceFactory extends AbstractServiceFactory
{
    ...
    private static $classMap = [
        ...
        'apps' => \StripeWPFS\Stripe\Service\Apps\AppsServiceFactory::class,
        'balance' => BalanceService::class,
        'balanceTransactions' => BalanceTransactionService::class,
        'billing' => \StripeWPFS\Stripe\Service\Billing\BillingServiceFactory::class,
        'billingPortal' => \StripeWPFS\Stripe\Service\BillingPortal\BillingPortalServiceFactory::class,
        'charges' => ChargeService::class,
        'checkout' => \StripeWPFS\Stripe\Service\Checkout\CheckoutServiceFactory::class,
        'climate' => \StripeWPFS\Stripe\Service\Climate\ClimateServiceFactory::class,
        ...
        'entitlements' => \StripeWPFS\Stripe\Service\Entitlements\EntitlementsServiceFactory::class,
        ...
        'financialConnections' => \StripeWPFS\Stripe\Service\FinancialConnections\FinancialConnectionsServiceFactory::class,
        'forwarding' => \StripeWPFS\Stripe\Service\Forwarding\ForwardingServiceFactory::class,
        'identity' => \StripeWPFS\Stripe\Service\Identity\IdentityServiceFactory::class,
        ...
        'issuing' => \StripeWPFS\Stripe\Service\Issuing\IssuingServiceFactory::class,
        ...
        'radar' => \StripeWPFS\Stripe\Service\Radar\RadarServiceFactory::class,
        'refunds' => RefundService::class,
        'reporting' => \StripeWPFS\Stripe\Service\Reporting\ReportingServiceFactory::class,
        ...
        'sigma' => \StripeWPFS\Stripe\Service\Sigma\SigmaServiceFactory::class,
        ...
        'tax' => \StripeWPFS\Stripe\Service\Tax\TaxServiceFactory::class,
        'taxCodes' => TaxCodeService::class,
        'taxIds' => TaxIdService::class,
        'taxRates' => TaxRateService::class,
        'terminal' => \StripeWPFS\Stripe\Service\Terminal\TerminalServiceFactory::class,
        'testHelpers' => \StripeWPFS\Stripe\Service\TestHelpers\TestHelpersServiceFactory::class,
        'tokens' => TokenService::class,
        'topups' => TopupService::class,
        'transfers' => TransferService::class,
        'treasury' => \StripeWPFS\Stripe\Service\Treasury\TreasuryServiceFactory::class,
        'v2' => \StripeWPFS\Stripe\Service\V2\V2ServiceFactory::class,
