 ...
 * @property (object{monetary: null|(object{currency: string, value: int}&\StripeWPFS\Stripe\StripeObject), type: string}&\StripeWPFS\Stripe\StripeObject) $amount
 * @property (object{scope: (object{price_type?: string, prices?: ((object{id: null|string}&\StripeWPFS\Stripe\StripeObject))[]}&\StripeWPFS\Stripe\StripeObject)}&\StripeWPFS\Stripe\StripeObject) $applicability_config
 ...
 * @property string|\StripeWPFS\Stripe\Customer $customer ID of the customer receiving the billing credits.
 ...
 * @property null|string|\StripeWPFS\Stripe\TestHelpers\TestClock $test_clock ID of the test clock this credit grant belongs to.
 ...
 */
class CreditGrant extends \StripeWPFS\Stripe\ApiResource
{
     ...
     *
     * @return \StripeWPFS\Stripe\Collection<CreditGrant> of ApiResources
     *
     * @throws \StripeWPFS\Stripe\Exception\ApiErrorException if the request fails
     */
